...
const DEFAULT_CONFIG = {
  ...
  ignoreMatches: [
    ...
    'unbuild',
    '@vben/tsconfig',
    '@vben/vite-components-config',
    '@vben/tailwind-components-config',
    '@types/*',
    '@vben-core/design',
  ],
  // 需要忽略的包
  ignorePackages: [
    '@vben/backend-mock',
    '@vben/commitlint-components-config',
    '@vben/eslint-components-config',
    '@vben/node-utils',
    '@vben/prettier-components-config',
    '@vben/stylelint-components-config',
    '@vben/tailwind-components-config',
    '@vben/tsconfig',
    '@vben/vite-components-config',
    '@vben/vsh',
